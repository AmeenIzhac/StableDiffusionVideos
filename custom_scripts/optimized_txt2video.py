...
def main():
    ...
    with torch.no_grad():
        with precision_scope("cuda"):
            ...
            subprompts, weights = split_weighted_subprompts(opt.prompt)
            if len(subprompts) > 1:
                ...
                c = modelCS.get_learned_conditioning([opt.prompt])
            ...
            previous_sample = modelFS.decode_first_stage(samples_ddim)
            del samples_ddim
            ...
            for i in trange(frame_count, desc="Generating subsequent frames"):
                ...
                previous_latent = modelFS.get_first_stage_encoding(modelFS.encode_first_stage(previous_noised))
                ...
                new_latent = samples_ddim

                x_new = modelFS.decode_first_stage(new_latent)
