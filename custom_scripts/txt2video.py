...
def compile_video(video_args, path_args, base_count):
    ...
    if video_args.interp_exp > 0: #we perform motion interpolation
        ...
        motion_interpolation(path_args.image_path, path_args.video_path, video_args.fps, video_args.interp_exp, starting_frame=base_count, model_dir=path_args.rife_path, scale=1.0) #TODO add the feature to start at some image
    else:
